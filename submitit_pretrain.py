...
def parse_args():
    ...
    parser.add_argument("--partition", default="community", type=str, help="Partition where to submit")
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/data/barry.ravichandran/repos/mae/checkpoint/").is_dir():
        p = Path(f"/data/barry.ravichandran/repos/mae/checkpoint/{user}/experiments")
